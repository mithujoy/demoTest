import { Component, OnInit, Inject, ViewContainerRef, AfterViewInit, AfterViewChecked, DoCheck } from '@angular/core';
...
export class NewtransactionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.testService = this.dialogData.serviceCode;
    // console.log(this.testService);
    var zikiService = [{ "id": 203, "service": "Mziiki" }];
    if (this.testService === 'Mziiki') {
      this.serviceNames = zikiService;
    } else {
      // get distribution Service Data
