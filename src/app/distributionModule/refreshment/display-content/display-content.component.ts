...
export class DisplayContentComponent implements OnInit, OnDestroy {
  ...
  constructor(private demoserviceServic: DemoserviceService, public dialog: MatDialog, /*private dragulaService: DragulaService,*/ public toastr: ToastrService, vRef: ViewContainerRef, private spinner: NgxSpinnerService, private loaderService: LoaderService) {
